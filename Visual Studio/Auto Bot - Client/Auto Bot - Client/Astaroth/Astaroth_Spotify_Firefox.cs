...
namespace Astaroth_Spotify_Firefox
{
    class Astaroth_Spotify_Firefox
    {
        ...
        public bool check_spotify_cookie_login(bool outdated_credentials, int count)
        {
            Bitmap spotify_check_outdated_credentials = new Bitmap(Application.StartupPath + @"\astaroth\spotify\outdated_creds_player.png");
            bool spotify_check_outdated_credentials_flag = true;
            int spotify_check_outdated_credentials_count = 0;
            int spotify_check_outdated_credentials_maxTries = count;

            while (spotify_check_outdated_credentials_flag == true)
            {
                try
                {
                    //Take Screenshot
                    ...
                    Rectangle pp_rect = Astaroth_Core.Astaroth_Core.FindImageOnScreen(spotify_check_outdated_credentials, false);

                    if (pp_rect != Rectangle.Empty)
                    {
                        outdated_credentials = true;
                        spotify_check_outdated_credentials_flag = false;
                    }
                    else
                    {
                        Logging.log_event("Spotify (Astaroth)", "Check Cookie Login", "Not found.");

                        // handle exception
                        if (++spotify_check_outdated_credentials_count == spotify_check_outdated_credentials_maxTries)
                        {
                            outdated_credentials = false;
                            spotify_check_outdated_credentials_flag = false;
                        }
                ...
                {
                    Logging.log_error("Spotify (Astaroth)", "Check Spotify Cookies Login", ex.Message);
                }
            }

            return outdated_credentials;
        }

        public void spotify_login_username(string username)
        {
            Bitmap spotify_login_username = new Bitmap(Application.StartupPath + @"\astaroth\spotify\login_password_textbox.png");
            bool spotify_login_username_flag = true;
            int spotify_login_username_count = 0;
            int spotify_login_username_maxTries = 15;
            while (spotify_login_username_flag == true)
            {
                try
                {
                    ...
                    {
                        Logging.log_event("Spotify (Astaroth)", "Fill Username Textbox", "Not found.");
                ...
                {
                    Logging.log_error("Spotify (Astaroth)", "Fill Login Username", ex.Message);
                }
            }
        }
        ...
        {
            Bitmap spotify_login_password = new Bitmap(Application.StartupPath + @"\astaroth\spotify\login_password_textbox.png");
            bool spotify_login_password_flag = true;
            int spotify_login_password_count = 0;
            int spotify_login_password_maxTries = 15;
            while (spotify_login_password_flag == true)
            {
                try
                {
                    ...
                    {
                        Logging.log_event("Spotify (Astaroth)", "Fill Password Textbox", "Not found.");
                ...
                {
                    Logging.log_error("Spotify (Astaroth)", "Fill Login Password", ex.Message);
                }
            }
        }
        ...
        {
            Bitmap spotify_login_button= new Bitmap(Application.StartupPath + @"\astaroth\spotify\login_button.png");
            bool spotify_login_button_flag = true;
            int spotify_login_button_count = 0;
            int spotify_login_button_maxTries = 15;
            while (spotify_login_button_flag == true)
            {
                try
                {
                    ...
                    {
                        Logging.log_event("Spotify (Astaroth)", "Spotify Login Button", "Not found.");
                ...
                {
                    Logging.log_error("Spotify (Astaroth)", "Click Login Button", ex.Message);
                }
            }
        }
        ...
        {
            Bitmap spotify_login_confirmed = new Bitmap(Application.StartupPath + @"\astaroth\spotify\confirm_login_button.png");
            bool spotify_login_confirmed_flag = true;
            int spotify_login_confirmed_count = 0;
            int spotify_login_confirmed_maxTries = 15;
            ...
            while (spotify_login_confirmed_flag == true)
            {
                ...
                {
                    Logging.log_error("Spotify (Astaroth)", "Check spotify_login Confirmed", ex.Message);
                }
            }
        ...
        {
            Bitmap accept_cookies_normal_button = new Bitmap(Application.StartupPath + @"\astaroth\spotify\accept_cookies_normal_button.png");
            bool accept_cookies_normal_button_flag = true;
            int accept_cookies_normal_button_count = 0;
            int accept_cookies_normal_button_maxTries = 20;
            while (accept_cookies_normal_button_flag == true)
            {
                try
                {
                    ...
                    {
                        Logging.log_event("Spotify (Astaroth)", "Cookies Normal Button", "Not found.");
                ...
                {
                    Logging.log_error("Spotify (Astaroth)", "Accept Cookies", ex.Message);
                }
            }
        }

        public void accept_cookies_abnormal_button()
        {
            Bitmap accept_cookies_abnormal_button = new Bitmap(Application.StartupPath + @"\astaroth\spotify\accept_cookies_abnormal_button.png");
            bool accept_cookies_abnormal_button_flag = true;
            int accept_cookies_abnormal_button_count = 0;
            int accept_cookies_abnormal_button_maxTries = 20;
            while (accept_cookies_abnormal_button_flag == true)
            {
                try
                {
                    //Take Screenshot
                    ...
                    Rectangle pp_rect = Astaroth_Core.Astaroth_Core.FindImageOnScreen(accept_cookies_abnormal_button, false);
                    ...
                    if (pp_rect != Rectangle.Empty)
                    {
                        ...
                        accept_cookies_abnormal_button_flag = false;
                    }
                    else
                    {
                        Logging.log_event("Spotify (Astaroth)", "Cookies Abnormal Button", "Not found.");

                        // handle exception
                        if (++accept_cookies_abnormal_button_count == accept_cookies_abnormal_button_maxTries)
                        {
                            accept_cookies_abnormal_button_flag = false;
                        }
                ...
                {
                    Logging.log_error("Spotify (Astaroth)", "Accept abnormal Cookies", ex.Message);
                }
            }
        }

        public void play_big_button(int count)
        {
            Bitmap play_big_button = new Bitmap(Application.StartupPath + @"\astaroth\spotify\play_big_button.png");
            bool play_big_button_flag = true;
            int play_big_button_count = 0;
            int play_big_button_maxTries = count;
            while (play_big_button_flag == true)
            {
                try
                {
                    ...
                    if (pp_rect != Rectangle.Empty)
                    {
                        //MessageBox.Show("Play Button Big: found.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    ...
                    {
                        Logging.log_event("Spotify (Astaroth)", "Play Big Button", "Not found.");
                ...
                {
                    Logging.log_error("Spotify (Astaroth)", "Click Recaptcha", ex.Message);
                }
            }
        }

        public bool skip_forward_button(bool click_confirmed)
        {
            Bitmap skip_forward_button = new Bitmap(Application.StartupPath + @"\astaroth\spotify\skip_forward_button.png");
            ...
            if (pp_rect != Rectangle.Empty)
            {
                ...
                //Jump away from the skip button
                Astaroth_Core.Astaroth_Core.SimulateMove(100, 100, 10);
        ...
        {
            Bitmap other_device_playing_bar = new Bitmap(Application.StartupPath + @"\astaroth\spotify\other_device_playing_bar.png");
            ...
            while (other_device_playing_bar_flag == true)
            {
                try
                {
                    ...
                    {
                        Logging.log_event("Spotify (Astaroth)", "Check Other Device Bar", "Not found.");
        ...
        {
            Bitmap other_device_playing_icon_button = new Bitmap(Application.StartupPath + @"\astaroth\spotify\other_device_playing_icon_button.png");
            ...
            while (other_device_playing_icon_button_flag == true)
            {
                try
                {
                    ...
                    {
                        Logging.log_event("Spotify (Astaroth)", "Check Other Device Icon", "Not found.");
        ...
        {
            Bitmap other_device_playing_use_this_button = new Bitmap(Application.StartupPath + @"\astaroth\spotify\other_device_playing_use_this_button.png");
            ...
            while (other_device_playing_use_this_button_flag == true)
            {
                try
                {
                    ...
                    {
                        Logging.log_event("Spotify (Astaroth)", "Check Other Device Use This Device", "Not found.");
        ...
        {
            Bitmap register_button = new Bitmap(Application.StartupPath + @"\astaroth\spotify\register_button.png");
            ...
            while (register_button_flag == true)
            {
                try
                {
                    ...
                    {
                        Logging.log_event("Spotify (Astaroth)", "Check Register Button", "Not found.");
